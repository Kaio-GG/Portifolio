...
const Icones = () => {
  return (
    <main className="cp-icones">
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/kaio-felipe-0462b7251/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="mailto:kaiofdss@gmail.com" 
            aria-label="Gmail"
            data-social="gmail">
            <div className="filled"></div>
            <svg
        ...
        <li className="icon-content">
            <a 
            href="https://wa.me/11954707257" // Substitua SEU_NUMERO pelo seu número de telefone
            aria-label="WhatsApp"
